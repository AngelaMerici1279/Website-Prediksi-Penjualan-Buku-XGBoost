...
|
*/
$config['base_url'] = 'http://localhost/aplikasiPrediksi/';
// // $config['base_url'] = 'https://' . $_SERVER['SERVER_NAME'] . '/aplikasiPrediksi/'; //live server dengan https
// $config['base_url'] = 'http://test.kanisiusmedia.co.id/'; //live server tanpa https
// // $config['base_url'] = 'http://test.kanisiusmedia.co.id/';
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
